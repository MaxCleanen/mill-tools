...
test("Две одинаковых детали. Рассортировка правильная", () => {
  ...
  expect(result["c01-s1-n50-t07.NC"]).toBe("o1-b3-s5--c01-s1-n50-t07.NC");
  expect(result["c01-s1-n60-t05.NC"]).toBe("o1-b4-s1--c01-s1-n60-t05.NC");
  expect(result["c01-s1-n70-t01.NC"]).toBe("o1-b5-s1--c01-s1-n70-t01.NC");
  ...
  expect(result["c05-s1-n50-t07.NC"]).toBe("o1-b3-s6--c05-s1-n50-t07.NC");
  expect(result["c05-s1-n60-t05.NC"]).toBe("o1-b4-s2--c05-s1-n60-t05.NC");
  expect(result["c05-s1-n70-t01.NC"]).toBe("o1-b5-s2--c05-s1-n70-t01.NC");
});
